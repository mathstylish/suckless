...
static const char *fonts[]          = { "Iosevka:style:medium:size=10", "JetBrainsMono Nerd Font Mono:style:medium:size=19" };
...
static const int switchtagonclose = 0;
...
static const Key keys[] = {
    ...
    { ShiftMask,                        XK_Print,  spawn,          SHCMD(screenshooter_cropped) },
    { 0,                                XK_Print,  spawn,          SHCMD(screenshooter_full) },
